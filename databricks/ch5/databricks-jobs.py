...
jobs_list = jobs_api.list_jobs(job_type=None)
...
for job in jobs_list['jobs']:
    ...
    print(job['settings']['name'], quartz_cron_expression)
    quartz_cron_expression = quartz_cron_expression is None and '' or quartz_cron_expression
    print(job['settings']['name'], quartz_cron_expression)
